...
:: ══════════════════════════════════════════════════════════════
::  Haven — Interactive Setup & Usage Wizard (Windows)
...
if exist "%HAVEN_DIR%node_modules\" (
...
:: ══════════════════════════════════════════════════════════════
:STEP3
call :HEADER "DATA DIRECTORY ^& CONFIGURATION"
...
if not exist "%HAVEN_DATA%\.env" (
    if exist "%HAVEN_DIR%.env.example" (
...
:: ══════════════════════════════════════════════════════════════
:STEP6
call :HEADER "CHANNELS ^& MESSAGING"
...
:: ══════════════════════════════════════════════════════════════
:STEP7
call :HEADER "VOICE CHAT ^& SCREEN SHARING"
...
:: ══════════════════════════════════════════════════════════════
:STEP8
call :HEADER "ADMIN TOOLS, THEMES ^& SECURITY"
...
echo   │    3. They click through cert warning ^& register    │
echo   │                                                     │
