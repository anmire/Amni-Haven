...
- `public/index.html` (~165 lines) — login/register page, EULA modal, Haven branding (◆ logo, tagline), theme bar (27 themes)
...
- `public/js/theme.js` (~198 lines) — theme switcher with server persistence, RGB cycling, custom palette (default fallback: haven)
...
- CDN: Ruffle.js (Flash emulation), EmulatorJS (retro ROM emulation — **experimental, not fully functional**), Spotify Web Playback SDK
...
- Branding: ◆ logo, HAVEN heading, "your server · your arcade · your rules" tagline
